...
describe('storage.controller', () => {
    ...
    describe('requestUpload and confirmUpload', () => {
        ...
        test('returns signed URL for requestUpload on valid input', async () => {
            ...
            expect(res.json).toHaveBeenCalledWith(expect.objectContaining({ data: { signedUrl: 'https://signed.example/upload', token: 'token-1', filePath: 'project_id_1/mocked-uuid_my..file.txt' } }));
        });
